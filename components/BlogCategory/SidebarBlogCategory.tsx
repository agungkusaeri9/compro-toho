...
import SidebarListCategory from './SidebarListCategory'
import RelatedPost from '../Article/RelatedPost'

const SidebarBlogCategory = ({ category_id }: { category_id: number }) => {
    return (
        <>
            <div className="md:w-1/2 lg:w-[32%]">
                ...
                <RelatedPost category_id={category_id} />
            </div>
        </>
    )
}
